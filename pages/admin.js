          ...
          <table className="min-w-full table-auto border-collapse">
            <thead className="bg-gray-100">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-sm font-semibold text-gray-600">Attending</th>
                <th className="px-6 py-3 text-left text-sm font-semibold text-gray-600">Guests</th>
                <th className="px-6 py-3 text-left text-sm font-semibold text-gray-600">Submitted At</th>
              </tr>
            </thead>
            <tbody>
              {rsvps.map((rsvp) => (
                <tr key={rsvp._id} className="border-b border-gray-200 hover:bg-gray-50">
                  <td className="px-6 py-4 text-sm text-gray-700">{rsvp.name}</td>
                  <td className="px-6 py-4 text-sm text-gray-700">{rsvp.attending ? "Yes" : "No"}</td>
